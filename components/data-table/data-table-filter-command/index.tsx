...
import { Loader2Icon, SearchIcon, XIcon } from "@/lib/icons";
...
export function DataTableFilterCommand({
  ...
  return (
    <div>
      ...
      >
        {isLoading ? (
          <Loader2Icon className="text-muted-foreground group-hover:text-popover-foreground mr-2 size-4 shrink-0 opacity-50" />
        ) : (
          <SearchIcon className="text-muted-foreground group-hover:text-popover-foreground mr-2 size-4 shrink-0 opacity-50" />
        )}
