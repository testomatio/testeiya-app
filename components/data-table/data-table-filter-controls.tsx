      ...
      {filterFields?.map((field) => {
        ...
        return (
          ...
          <AccordionItem key={value} value={value} className="-mx-2 px-2">
            <AccordionTrigger className="text-muted-foreground data-panel-open:text-foreground hover:text-foreground hover:bg-muted/40 w-full items-center gap-2 px-2 py-0 hover:no-underline">
