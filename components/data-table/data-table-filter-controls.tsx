      ...
      {filterFields?.map((field) => {
        ...
        return (
          ...
          <AccordionItem key={value} value={value} className="-mx-2 px-2">
            <AccordionTrigger className="data-[state=closed]:text-muted-foreground data-[state=open]:text-foreground focus-within:data-[state=closed]:text-foreground hover:data-[state=closed]:text-foreground hover:bg-muted/40 w-full items-center gap-2 px-2 py-0 hover:no-underline">
